     ...
     <div class="breadcrumb_total">
    	<div class="container">
            <nav class="breadcrumb">
              ...
              <span class="breadcrumb-item active">Lỗi đăng nhập</span>
            </nav>
        </div>
    </div> <!-- End Breadcrumb -->
    	...
    	<div class="container">
        	<div class="row">
            	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-md-push-3 col-lg-push-3 text-center">
                	<img src="images/icon-no.png" width="64" height="64"><br><br>
                	<h3><i class="fa fa-times" aria-hidden="true"></i> Lỗi đăng nhập</h3><br>
