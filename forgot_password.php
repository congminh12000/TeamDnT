...
$forgotpass_transaction = new tNG_update($conn_cnn_teamdnt);
...
// Add columns
$forgotpass_transaction->setTable("account");
...
?>
	...
	<td>
		<input type="text" name="email" id="email" value="<?php echo KT_escapeAttribute($row_rsaccount['email']); ?>" size="32" />
		<?php echo $tNGs->displayFieldHint("email");?>
		<?php echo $tNGs->displayFieldError("account", "email"); ?>
	</td>
</tr>
			<tr class="KT_buttons"> 
				<td colspan="2">
