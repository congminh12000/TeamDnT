...
// Start Variable definitions
  ...
  $tNG_login_config["connection"] = "cnn_teamdnt";
  ...
  $tNG_login_config["max_tries"] = "6";
  $tNG_login_config["max_tries_field"] = "loginerrortotal";
  $tNG_login_config["max_tries_disableinterval"] = "28";
  ...
  $tNG_login_config_redirect_success["2"] = "admincp/admincp.php";
  $tNG_login_config_redirect_failed["2"] = "login_error.php";
  $tNG_login_config_redirect_success["3"] = "salesmanagercp/salesmanagercp.php";
  $tNG_login_config_redirect_failed["3"] = "login_error.php";
  $tNG_login_config_redirect_success["4"] = "editorcp/editorcp.php";
  ...
  $tNG_login_config_redirect_success["5"] = "traineecp/traineecp.php";
  $tNG_login_config_redirect_failed["5"] = "login_error.php";
