...
$ins_copyright = new tNG_multipleInsert($conn_cnn_teamdnt);
...
$ins_copyright->addColumn("businessbehance", "STRING_TYPE", "POST", "businessbehance");
$ins_copyright->addColumn("businessdribbble", "STRING_TYPE", "POST", "businessdribbble");
...
$upd_copyright = new tNG_multipleUpdate($conn_cnn_teamdnt);
...
$upd_copyright->addColumn("businessbehance", "STRING_TYPE", "POST", "businessbehance");
$upd_copyright->addColumn("businessdribbble", "STRING_TYPE", "POST", "businessdribbble");
...
$del_copyright = new tNG_multipleDelete($conn_cnn_teamdnt);
...
?>
                <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                  <tr>
                    <td width="20%" class="KT_th"><label for="businessname_<?php echo $cnt1; ?>">Name:</label></td>
                    <td colspan="2"><input type="text" name="businessname_<?php echo $cnt1; ?>" id="businessname_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businessname']); ?>" size="36" maxlength="68" />
                  ...
                  <tr>
                    ...
                    <td width="28%"><input type="file" name="businesslogo_<?php echo $cnt1; ?>" id="businesslogo_<?php echo $cnt1; ?>" size="32" />
                      <?php echo $tNGs->displayFieldError("copyright", "businesslogo", $cnt1); ?></td>
                    <td width="52%"><?php 
						// Show If File Exists (region4)
						if (tNG_fileExists("../images/", "{rscopyright.businesslogo}")) {
						?>
												<img src="<?php echo tNG_showDynamicImage("../", "../images/", "{rscopyright.businesslogo}");?>" />
												<?php 
                  ...
                  <tr>
                    <td class="KT_th"><label for="businessaddress_<?php echo $cnt1; ?>">Address:</label></td>
                    <td colspan="2"><input type="text" name="businessaddress_<?php echo $cnt1; ?>" id="businessaddress_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businessaddress']); ?>" size="48" maxlength="168" />
                      <?php echo $tNGs->displayFieldHint("businessaddress");?> <?php echo $tNGs->displayFieldError("copyright", "businessaddress", $cnt1); ?></td>
                  </tr>
                  <tr>
                    <td class="KT_th"><label for="businessphonenumber_<?php echo $cnt1; ?>">Phone number:</label></td>
                    <td colspan="2"><input type="text" name="businessphonenumber_<?php echo $cnt1; ?>" id="businessphonenumber_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businessphonenumber']); ?>" size="20" maxlength="16" />
                  ...
                  <tr>
                    ...
                    <td colspan="2"><input type="text" name="businessemail_<?php echo $cnt1; ?>" id="businessemail_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businessemail']); ?>" size="36" maxlength="168" />
                  ...
                  <tr>
                    ...
                    <td colspan="2"><input type="text" name="businesswebsite_<?php echo $cnt1; ?>" id="businesswebsite_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businesswebsite']); ?>" size="36" maxlength="68" />
                  ...
                  <tr>
                    <td class="KT_th"><label for="businessfanpageaddon_<?php echo $cnt1; ?>">Fanpage Add-on:</label></td>
                  ...
                  <tr>
                    <td class="KT_th"><label for="businessfacebook_<?php echo $cnt1; ?>"><i class="fa fa-facebook-square" aria-hidden="true"></i>&nbsp;&nbsp;Facebook link:</label></td>
                    <td colspan="2"><input type="text" name="businessfacebook_<?php echo $cnt1; ?>" id="businessfacebook_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businessfacebook']); ?>" size="48" maxlength="168" />
                      <?php echo $tNGs->displayFieldHint("businessfacebook");?> <?php echo $tNGs->displayFieldError("copyright", "businessfacebook", $cnt1); ?></td>
                  </tr>
                  <tr>
                    <td class="KT_th"><label for="businessgoogle_<?php echo $cnt1; ?>"><i class="fa fa-google-plus-square" aria-hidden="true"></i>&nbsp;&nbsp;Google link:</label></td>
                    <td colspan="2"><input type="text" name="businessgoogle_<?php echo $cnt1; ?>" id="businessgoogle_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businessgoogle']); ?>" size="48" maxlength="168" />
                      <?php echo $tNGs->displayFieldHint("businessgoogle");?> <?php echo $tNGs->displayFieldError("copyright", "businessgoogle", $cnt1); ?></td>
                  </tr>
                  <tr>
                    <td class="KT_th"><label for="businessyoutube_<?php echo $cnt1; ?>"><i class="fa fa-youtube-square" aria-hidden="true"></i>&nbsp;&nbsp;Youtube link:</label></td>
                    <td colspan="2"><input type="text" name="businessyoutube_<?php echo $cnt1; ?>" id="businessyoutube_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businessyoutube']); ?>" size="48" maxlength="168" />
                      <?php echo $tNGs->displayFieldHint("businessyoutube");?> <?php echo $tNGs->displayFieldError("copyright", "businessyoutube", $cnt1); ?></td>
                  </tr>
                  <tr>
                    <td class="KT_th"><label for="businessinstagram_<?php echo $cnt1; ?>"><i class="fa fa-instagram" aria-hidden="true"></i>&nbsp;&nbsp;Instagram link:</label></td>
                    <td colspan="2"><input type="text" name="businessinstagram_<?php echo $cnt1; ?>" id="businessinstagram_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businessinstagram']); ?>" size="48" maxlength="168" />
                      <?php echo $tNGs->displayFieldHint("businessinstagram");?> <?php echo $tNGs->displayFieldError("copyright", "businessinstagram", $cnt1); ?></td>
                  </tr>
                  <tr>
                    <td class="KT_th"><label for="businesspinterest_<?php echo $cnt1; ?>"><i class="fa fa-pinterest-square" aria-hidden="true"></i>&nbsp;&nbsp;Pinterest link:</label></td>
                    <td colspan="2"><input type="text" name="businesspinterest_<?php echo $cnt1; ?>" id="businesspinterest_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businesspinterest']); ?>" size="48" maxlength="168" />
                      <?php echo $tNGs->displayFieldHint("businesspinterest");?> <?php echo $tNGs->displayFieldError("copyright", "businesspinterest", $cnt1); ?></td>
                  </tr>
                  <tr>
                    <td class="KT_th"><label for="businessbehance_<?php echo $cnt1; ?>"><i class="fa fa-behance-square" aria-hidden="true"></i>&nbsp;&nbsp;Behance link:</label></td>
                    <td colspan="2"><input type="text" name="businessbehance_<?php echo $cnt1; ?>" id="businessbehance_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businessbehance']); ?>" size="48" maxlength="168" />
                      <?php echo $tNGs->displayFieldHint("businessbehance");?> <?php echo $tNGs->displayFieldError("copyright", "businessbehance", $cnt1); ?></td>
                  </tr>
                  <tr>
                    <td class="KT_th"><label for="businessdribbble_<?php echo $cnt1; ?>"><i class="fa fa-dribbble" aria-hidden="true"></i>&nbsp;&nbsp;Dribbble link:</label></td>
                    <td colspan="2"><input type="text" name="businessdribbble_<?php echo $cnt1; ?>" id="businessdribbble_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businessdribbble']); ?>" size="48" maxlength="168" />
                      <?php echo $tNGs->displayFieldHint("businessdribbble");?> <?php echo $tNGs->displayFieldError("copyright", "businessdribbble", $cnt1); ?></td>
                  </tr>
                  <tr>
                    <td class="KT_th"><label for="businesstwitter_<?php echo $cnt1; ?>"><i class="fa fa-twitter-square" aria-hidden="true"></i>&nbsp;&nbsp;Twitter link:</label></td>
                    <td colspan="2"><input type="text" name="businesstwitter_<?php echo $cnt1; ?>" id="businesstwitter_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscopyright['businesstwitter']); ?>" size="48" maxlength="168" />
