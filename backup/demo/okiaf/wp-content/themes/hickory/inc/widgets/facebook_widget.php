...
add_action( 'widgets_init', 'hickory_facebook_load_widget' );

function hickory_facebook_load_widget() {
	register_widget( 'hickory_facebook_widget' );
}

class hickory_facebook_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function hickory_facebook_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'hickory_facebook_widget', 'description' => __('A widget that displays a Facebook Like Box', 'hickory_facebook_widget') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'hickory_facebook_widget' );

		/* Create the widget. */
		parent::__construct( 'hickory_facebook_widget', __('Hickory: Facebook Like Box', 'hickory_facebook_widget'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => 'Find us on Facebook', 'width' => 300, 'height' => 290, 'header' => 'on', 'faces' => 'on', 'page_url' => '', 'stream' => true);
		...
		<p>
			...
			<small>Note: If using this widget in the footer you should enter 225 in width</small>
		</p>
