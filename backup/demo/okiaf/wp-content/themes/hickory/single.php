<?php get_header(); ?>
					...
					<?php if(vp_metabox('hickory_post.hickory_post_type') == 'video' || vp_metabox('hickory_post.music.0.source') == 'embed') : ?>
						...
						<div class="post-image">
							...
							<?php if(vp_metabox('hickory_post.video.0.source') == 'embed' || vp_metabox('hickory_post.music.0.source') == 'embed') : ?>
								...
								<?php elseif(($video_url_length) == '8' || ($video_url_length) == '9' || ($video_url_length) == '10') : ?>
			...
			<?php endif; ?>	
					...
					<div class="post-header">
						...
						?>
						<span class="post-meta"><?php _e('vào', 'hickory'); ?> <?php the_time( get_option('date_format') ); ?></span>
					...
					<?php else : ?>
					<strong>Bấm like hoặc chia sẻ bài viết nếu bạn thích.</strong><br/>
					<div class="post-share">
						...
						<span class="share-item">
						<iframe src="https://www.facebook.com/plugins/share_button.php?href=https%3A%2F%2F<?php the_permalink(); ?>%2Fdocs%2Fplugins%2F&layout=button_count&size=small&mobile_iframe=false&appId=676814105767278&width=86&height=20" width="86" height="20" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
						</span>
						<span class="share-item">
