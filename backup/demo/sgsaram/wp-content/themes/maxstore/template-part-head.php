		...
		<div class="header-login col-sm-4 col-xs-4 col-sm-pull-4"> 
			<?php if ( class_exists( 'WooCommerce' ) && get_theme_mod( 'my-account-link', 1 ) == 1 ) { // Login Register  ?>
				<?php if ( is_user_logged_in() ) { ?>
					<a href="<?php echo __('[:en]http://teamdnt.asia/demo/sgsaram/wcmp_vendor_dashboard/[:ko]http://teamdnt.asia/demo/sgsaram/ko/wcmp_vendor_dashboard/'); ?>">Account</a> / <a href="<?php echo wp_logout_url( get_permalink() ); ?>">Logout</a>
