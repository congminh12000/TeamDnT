...
Glades is a modern Magazine Theme for a local news or any other content focused website.

== Description ==

Glades is a modern Magazine Theme for a local news or any other content focused website. The magazine-styled homepage is built with WordPress core features like Customizer and Widgets, which makes the setup super fast, flexible and easy. The theme comes with a beautiful Featured Content area and responsive design, looking great on every device.

For more information about Glades please go to https://themezee.com/themes/glades/

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Glades in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Go to https://themezee.com/docs/glades-documentation/ for a guide on how to customize this theme.
...
* updated language files for French

= 1.1.3 =
* added default featured images for featured content posts
...
* added translation files for Dutch, Italian, French, Greek, Spanish and German
...
* fixed description of widgets and sidebars
...
* removed unnecessary header-content.php file

= 1.0.1 =
* added new classes entry-title, updated and author for google microformats structure
* added clearfix class to Magazine Homepage widget area
* removed unnecessary HTML markup and Genericons in theme-info.php
* removed unnecessary footer navigation menu location
* fixed styling of footer line and cleaned up CSS in style.css
...
Glades WordPress Theme, Copyright 2016 ThemeZee.com
...
Glades bundles the following third-party resources:
...
Image 1: http://pixabay.com/en/buildings-skyline-skyscrapers-city-200684/
Image 2: http://pixabay.com/en/london-bus-double-decker-road-590114/
Image 3: http://pixabay.com/en/taxicabs-new-york-taxis-cabs-498436/
Image 4: http://pixabay.com/en/car-retro-old-oldtimer-grunge-448553/
Image 5: http://pixabay.com/en/legs-window-car-dirt-road-relax-434918/
Image 6: http://pixabay.com/en/bike-street-neighborhood-sunset-665925/
Image 7: http://pixabay.com/en/forest-trees-light-dust-clearing-653448/
...
Glades uses the Featured Content class for the featured content area.
