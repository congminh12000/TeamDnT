    ...
    <div class="breadcrumb_total">
    	<div class="container">
            <nav class="breadcrumb">
              ...
              <span class="breadcrumb-item active">Gửi liên hệ thành công</span>
            </nav>
        </div>
    </div> <!-- End Breadcrumb -->
    	...
    	<div class="container">
        	<div class="row">
            	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-md-push-3 col-lg-push-3 text-center">
                	...
                	<h3><i class="fa fa-check-square-o" aria-hidden="true"></i> Chúng tôi đã nhận yêu cầu từ quý khách.</h3>
                    <span class="notes">Chúng tôi sẽ phản hồi sớm nhất có thể. Xin cảm ơn!</span><br><br>
